...
export const icons = {
  ...
  userPlus: () => svg('<path d="M15 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><path d="M19 8v6M22 11h-6"/>'),
  card: () => svg('<rect x="2" y="5" width="20" height="14" rx="2.5"/><path d="M2 10h20"/><path d="M6 15h4"/>'),
  printer: () => svg('<path d="M6 9V3h12v6"/><rect x="6" y="14" width="12" height="7"/><path d="M6 18H4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-2"/>'),
  ...
  receipt: () => svg('<path d="M4 2v20l2.5-1.5L9 22l2.5-1.5L14 22l2.5-1.5L19 22V2l-2.5 1.5L14 2l-2.5 1.5L9 2 6.5 3.5z"/><path d="M8 8h8M8 12h8M8 16h5"/>'),
  chart: () => svg('<path d="M3 3v18h18"/><path d="M7 15l4-5 3 3 5-7"/>'),
  motorcycle: () => svg('<circle cx="5.5" cy="17" r="3.5"/><circle cx="18.5" cy="17" r="3.5"/><path d="M15 17h-6l-2-5h8l3 5"/><path d="M9 12 7.5 8H5"/><path d="M14 8h4"/>'),
  bicycle: () => svg('<circle cx="5.5" cy="17" r="3.5"/><circle cx="18.5" cy="17" r="3.5"/><path d="M5.5 17 9 8h5"/><path d="m12 17 3.5-9"/><path d="M9.5 8h5.5l3.5 9"/><path d="M14.5 5.5h2.5"/>'),
  ...
  checkCircle: () => svg('<circle cx="12" cy="12" r="10"/><path d="m8 12 3 3 5-6"/>'),
  ...
  arrowLeft: () => svg('<path d="M19 12H5M11 19l-7-7 7-7"/>'),
  ...
  package: () => svg('<path d="m7.5 4.27 9 5.15"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="m3.3 7 8.7 5 8.7-5M12 22V12"/>'),
  ...
  qr: () => svg('<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3h-3zM18 18h3v3h-3z"/>')
};
